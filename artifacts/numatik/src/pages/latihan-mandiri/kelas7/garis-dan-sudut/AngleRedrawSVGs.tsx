...
function Q1b({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 500 600" label="Gambar ulang soal 1 bagian b: sudut y dan 127 derajat" colors={colors}>
      ...
      <Line x1={252} y1={430} x2={338} y2={30} colors={colors} />
      <Point cx={252} cy={430} colors={colors} />
      <path
        d="M204 373 A70 70 0 0 1 267 362"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M267 362 A105 105 0 0 1 330 376"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <Text x={248} y={350} colors={colors} size={26} italic>
        y
      </Text>
      <Text x={380} y={302} colors={colors} size={23}>
        127°
      </Text>
    </SvgFrame>
  );
...
function Q1c({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 520 500" label="Gambar ulang soal 1 bagian c: sudut 140 derajat dan z" colors={colors}>
      ...
      <path
        d="M207 203 A72 72 0 0 0 207 300"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <path
        d="M307 202 A72 72 0 0 1 307 300"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <Text x={132} y={310} colors={colors} size={24}>
        140°
      </Text>
      <Text x={373} y={310} colors={colors} size={27} italic>
        z
      </Text>
    </SvgFrame>
  );
...
function Q1d({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 320" label="Gambar ulang soal 1 bagian d: sudut a, 50 derajat, dan 20 derajat" colors={colors}>
      ...
      <path
        d="M126 268 A94 94 0 0 1 190 184"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <path
        d="M268 180 A58 58 0 0 1 275 240"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <path
        d="M348 268 A128 128 0 0 0 342 207"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <Text x={150} y={165} colors={colors} size={24} italic>
        a
      </Text>
      <Text x={300} y={168} colors={colors} size={21}>
        50°
      </Text>
      <Text x={415} y={242} colors={colors} size={21}>
        20°
      </Text>
    </SvgFrame>
  );
...
function Q1e({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 260" label="Gambar ulang soal 1 bagian e: sudut 50 derajat dan b" colors={colors}>
      ...
      <path
        d="M205 28 A80 80 0 0 0 226 107"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <path
        d="M365 28 A80 80 0 0 1 346 104"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <Text x={155} y={78} colors={colors} size={22}>
        50°
      </Text>
      <Text x={395} y={82} colors={colors} size={26} italic>
        b
      </Text>
    </SvgFrame>
  );
...
function Q1f({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 430" label="Gambar ulang soal 1 bagian f: sudut c dan 80 derajat" colors={colors}>
      <Line x1={22} y1={35} x2={558} y2={410} colors={colors} />
      <Line x1={52} y1={405} x2={564} y2={15} colors={colors} />
      <Point cx={300} cy={220} colors={colors} />
      <RightAngle d="M270 190 L298 168 L323 194" colors={colors} />
      <path
        d="M247 195 A82 82 0 0 0 250 288"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <path
        d="M346 180 A88 88 0 0 1 355 282"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
...
function Q2({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 350" label="Gambar ulang soal 2: garis melalui titik B, D, E dan sinar A, C, F" colors={colors}>
      ...
      <Line x1={105} y1={315} x2={495} y2={55} colors={colors} />
      ...
      <Text x={200} y={180} colors={colors} size={17}>
        40°
      </Text>
      <Text x={365} y={180} colors={colors} size={17}>
        40°
      </Text>
    </SvgFrame>
  );
...
function Q3({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 370" label="Gambar ulang soal 3: konfigurasi sudut di titik A" colors={colors}>
      ...
      <Text x={342} y={202} colors={colors} size={18}>
        40°
      </Text>
    </SvgFrame>
  );
...
function Q4({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 380" label="Gambar ulang soal 4: sudut 20 derajat dan setengah x ditambah 15 derajat" colors={colors}>
      ...
      <path
        d="M52 158 A80 80 0 0 1 93 190"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
      <Text x={95} y={170} colors={colors} size={22}>
        20°
      </Text>
      <Text x={300} y={300} colors={colors} size={21}>
        ½x + 15°
      </Text>
    </SvgFrame>
  );
...
function Q5({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 360" label="Gambar ulang soal 5: sudut PQR dengan dua bentuk aljabar" colors={colors}>
      ...
      />
      <path
        d="M275 300 A105 105 0 0 0 270 220"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
...
function Q10({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 350" label="Gambar ulang soal 10: tiga garis dan sudut 2x serta 7x di titik O" colors={colors}>
      ...
      <RightAngle d="M265 165 L265 132 L300 132" colors={colors} />
...
function Q12({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 360" label="Gambar ulang soal 12: dua garis berpotongan dengan 28 ditambah a derajat dan 77 derajat" colors={colors}>
      ...
      <Text x={397} y={165} colors={colors} size={18}>
        77°
      </Text>
    </SvgFrame>
  );
...
function Q13({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 360" label="Gambar ulang soal 13: dua garis berpotongan di titik E" colors={colors}>
      ...
      <Text x={190} y={188} colors={colors} size={18}>
        73°
      </Text>
