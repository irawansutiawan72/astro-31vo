...
function Q1b({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 500 600" label="Gambar ulang soal 1 bagian b: sudut y dan 127 derajat" colors={colors}>
      ...
      <path
        d="M217 369 A70 70 0 0 1 265 361"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <path
        d="M271 331 A100 100 0 0 1 333 484"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
        strokeLinecap="round"
      />
      <Text x={241} y={342} colors={colors} size={26} italic>
        y
      </Text>
...
function Q1c({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 520 500" label="Gambar ulang soal 1 bagian c: sudut 140 derajat dan z" colors={colors}>
      ...
      <path
        d="M219 215 A52 52 0 0 0 215 280"
        fill="none"
        stroke={colors.arc}
        strokeWidth="3"
      />
  ...
  return (
    <SvgFrame viewBox="0 0 600 320" label="Gambar ulang soal 1 bagian d: sudut a, 50 derajat, dan 20 derajat" colors={colors}>
      ...
      <path
        ...
        strokeWidth="3"
      />
      <Text x={158} y={222} colors={colors} size={24} italic>
        a
      </Text>
      <Text x={270} y={205} colors={colors} size={21}>
        50°
      </Text>
      <Text x={305} y={256} colors={colors} size={21}>
        20°
      </Text>
    </SvgFrame>
  );
...
function Q1f({ colors }: { colors: DiagramColors }) {
  return (
    <SvgFrame viewBox="0 0 600 430" label="Gambar ulang soal 1 bagian f: sudut c dan 80 derajat" colors={colors}>
      ...
      <RightAngle d="M270 198 L249 220 L270 244 L293 220 Z" colors={colors} />
      <path
