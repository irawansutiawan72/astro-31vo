...
export const latihanDasar = [
  { no: 1, soal: "Perhatikan gambar!\nDaerah yang diarsir adalah juring dengan sudut pusat 40°. Jika O adalah pusat lingkaran, r = 21 cm, dan $\\pi = \\frac{22}{7}$, luas daerah yang diarsir adalah ...", options: ["A. 77 $cm^2$", "B. 154 $cm^2$", "C. 231 $cm^2$", "D. 308 $cm^2$"] },
  { no: 2, soal: "Perhatikan gambar lingkaran di samping! Jika O pusat lingkaran, OP = 21 cm, dan sudut pusat $\\angle POQ = 60°$, panjang busur kecil PQ adalah ... ($\\pi = \\frac{22}{7}$)", options: ["A. 22 cm", "B. 33 cm", "C. 44 cm", "D. 66 cm"] },
  { no: 3, soal: "Perhatikanlah gambar berikut.\nDiketahui O adalah titik pusat lingkaran, $\\angle POQ = 50°$, dan $\\angle QOR = 75°$. Jika panjang busur QR = 60 cm, panjang busur PQ adalah ...", options: ["A. 40 cm", "B. 45 cm", "C. 50 cm", "D. 55 cm"] },
  { no: 4, soal: "Perhatikan gambar!\nPada lingkaran yang sama, $\\angle ROS = 90°$ dan $\\angle POQ = 135°$. Jika luas juring ORS = 60 $cm^2$, luas juring OPQ adalah ...", options: ["A. 40 $cm^2$", "B. 75 $cm^2$", "C. 90 $cm^2$", "D. 105 $cm^2$"] },
  ...
  { no: 6, soal: "Perhatikan gambar! Bangun yang diarsir terdiri atas persegi panjang berukuran 21 cm × 21 cm dan setengah lingkaran berdiameter 21 cm. Jika $\\pi = \\frac{22}{7}$, luas daerah yang diarsir adalah ...", options: ["A. 577,5 $cm^2$", "B. 614,25 $cm^2$", "C. 693 $cm^2$", "D. 718,5 $cm^2$"] },
  { no: 7, soal: "Perhatikan gambar persegi sisi 14 cm. Daerah yang diarsir adalah luas persegi dikurangi dua seperempat lingkaran berjari-jari 7 cm. Luas daerah yang diarsir adalah ... ($\\pi = \\frac{22}{7}$)", options: ["A. 59,5 $cm^2$", "B. 112 $cm^2$", "C. 119 $cm^2$", "D. 224 $cm^2$"] },
  { no: 8, soal: "Perhatikan gambar! Panjang jari-jari setengah lingkaran kecil adalah 5 cm, sedangkan masing-masing dari dua setengah lingkaran besar berjari-jari 10 cm. Keliling batas daerah yang diarsir adalah ... ($\\pi = 3,14$)", options: ["A. 47,1 cm", "B. 62,8 cm", "C. 78,5 cm", "D. 94,2 cm"] },
  { no: 9, soal: "Perhatikan gambar! Sebuah persegi panjang berukuran 28 cm × 14 cm memuat satu setengah lingkaran berdiameter 28 cm dan dua setengah lingkaran berdiameter 14 cm. Keliling daerah yang diarsir adalah ... ($\\pi = \\frac{22}{7}$)", options: ["A. 44 cm", "B. 66 cm", "C. 88 cm", "D. 112 cm"] },
  { no: 10, soal: "Perhatikan gambar! Sebuah lingkaran berjari-jari 10 cm memiliki juring 90° yang tidak diarsir. Daerah yang diarsir adalah tembereng kecil di antara busur dan talibusur. Luas daerah yang diarsir adalah ... ($\\pi = 3,14$)", options: ["A. 28,5 $cm^2$", "B. 50 $cm^2$", "C. 78,5 $cm^2$", "D. 128,5 $cm^2$"] },
  { no: 11, soal: "Perhatikan gambar berikut! Diameter setengah lingkaran besar adalah 26 cm dan diameter setengah lingkaran kecil adalah 14 cm. Kedua setengah lingkaran disusun seperti pada gambar. Jika $\\pi = 3{,}14$, keliling bangun tersebut adalah ...", options: ["A. 74,8 cm", "B. 86,8 cm", "C. 102,8 cm", "D. 125,6 cm"] },
  ...
  { no: 14, soal: "Perhatikan gambar! Diketahui O adalah titik pusat lingkaran dan $\\angle ACB = 30°$. Besar sudut pusat $\\angle AOB$ adalah ...", options: ["A. 15°", "B. 30°", "C. 45°", "D. 60°"] },
  { no: 15, soal: "Perhatikan gambar! Titik O adalah pusat lingkaran. Diketahui $\\angle ACE = 30°$. Besar sudut pusat $\\angle AOE$ adalah ...", options: ["A. 30°", "B. 45°", "C. 60°", "D. 90°"] },
  { no: 16, soal: "Perhatikan gambar! Diketahui $\\angle OAD = 20°$ dan $\\angle OBD = 30°$. Garis AC melalui pusat O sehingga AC merupakan diameter. Besar $\\angle BOC$ adalah ...", options: ["A. $50°$", "B. $70°$", "C. $80°$", "D. $100°$"] },
  { no: 17, soal: "Pada gambar di bawah ini, AB merupakan diameter dan diketahui besar $\\angle AOC = 82°$. Besar sudut $\\angle BDC$ adalah ...", options: ["A. $41°$", "B. $49°$", "C. $82°$", "D. $98°$"] },
  ...
  { no: 19, soal: "Perhatikan gambar! AD merupakan diameter lingkaran. Diketahui $\\angle ADB = 28°$ dan sudut perpotongan tali busur AC dan BD yang ditandai adalah 60°. Berturut-turut, besar $\\angle BAC$, $\\angle ADC$, dan $\\angle DAC$ adalah ...", options: ["A. $30°$, $58°$, $32°$", "B. $32°$, $58°$, $30°$", "C. $30°$, $62°$, $28°$", "D. $60°$, $58°$, $32°"] },
  { no: 20, soal: "Perhatikan gambar segiempat tali busur ABCD! Diketahui $\\angle ABC = 74°$ dan sudut luar di C adalah 100°. Berturut-turut, besar $\\angle DCB$, $\\angle BAD$, dan $\\angle ADC$ adalah ...", options: ["A. $80°$, $100°$, $106°$", "B. $100°$, $80°$, $106°$", "C. $80°$, $106°$, $100°$", "D. $74°$, $100°$, $106°"] },
  ...
  { no: 25, soal: "Seorang pengusaha akan membuat bianglala seperti yang ada di Dufan.\nJika tempat duduk pada bianglala sebanyak 44 buah dan masing-masing tempat duduk berjarak 3 m, berapakah panjang jari-jari bianglala? (Gunakan $\\pi = \\frac{22}{7}$.)", options: ["A. 7 m", "B. 10,5 m", "C. 14 m", "D. 21 m"] },
  { no: 26, soal: "Perhatikan gambar berikut!\nKolam ikan Pak Arvin berbentuk seperti gambar. Panjang keseluruhan kolam 21 cm dan diameter kedua setengah lingkaran 14 cm. Jika di sekeliling kolam dipagari kawat berduri dua kali putaran, maka panjang minimum kawat yang dibutuhkan adalah .... (Gunakan $\\pi = \\frac{22}{7}$.)", options: ["A. 72 cm", "B. 86 cm", "C. 116 cm", "D. 172 cm"] },
  ...
  { no: 28, soal: "Perhatikan gambar berikut!\nKolam Pak Tedi berbentuk setengah gelang: diameter setengah lingkaran luar 28 m, jari-jari setengah lingkaran dalam 7 m, dan setiap ruas garis lurus pada bagian bawah panjangnya 7 m. Jika keliling kolam diberi pagar kawat dua kali putaran, maka dibutuhkan kawat minimum sepanjang .... (Gunakan $\\pi = \\frac{22}{7}$.)", options: ["A. 66 m", "B. 88 m", "C. 132 m", "D. 160 m"] },
  { no: 29, soal: "Perhatikan gambar berikut.\nJika O adalah pusat lingkaran, OQ = 10 cm dan garis QP menyinggung lingkaran di Q dengan QP = 24 cm, panjang OP adalah ....", options: ["A. 16 cm", "B. 26 cm", "C. 34 cm", "D. 36 cm"] },
  { no: 30, soal: "Panjang jari-jari dua lingkaran masing-masing adalah 2 cm dan 10 cm. Panjang garis singgung persekutuan luarnya adalah 15 cm. Jarak kedua titik pusat lingkaran adalah ....", options: ["A. 13 cm", "B. 17 cm", "C. 23 cm", "D. 25 cm"] },
  ...
  { no: 36, soal: "Gambar di bawah ini adalah penampang 10 buah gelas berbentuk tabung dengan jari-jari 10 cm, tersusun dalam 2 baris dan 5 kolom. Panjang tali minimal yang diperlukan untuk mengikat gelas-gelas tersebut dengan susunan seperti dalam gambar adalah .... (Gunakan $\\pi = 3,14$.)", options: ["A. 261,8 cm", "B. 262,8 cm", "C. 261,6 cm", "D. 262,6 cm"] },
];
