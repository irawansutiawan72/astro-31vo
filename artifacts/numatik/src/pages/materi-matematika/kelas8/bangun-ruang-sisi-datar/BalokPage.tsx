...
const balokNets: BalokCell[][] = [
  [
    { x: 0,      y: CT,         w: CT, h: CL, color: "#22c55e", label: "l×t" },
    { x: CT,     y: 0,          w: CP, h: CT, color: "#8b5cf6", label: "p×t" },
    { x: CT,     y: CT,         w: CP, h: CL, color: "#eab308", label: "p×l" },
    { x: CT,     y: CT+CL,      w: CP, h: CL, color: "#ef4444", label: "p×l" },
    { x: CT,     y: CT+CL+CL,   w: CP, h: CT, color: "#3b82f6", label: "p×t" },
    { x: CT+CP,  y: CT,         w: CT, h: CL, color: "#f97316", label: "l×t" },
  ],
  [
  ...
  [
    ...
    { x: CT,            y: 0,          w: CP, h: CT, color: "#8b5cf6", label: "p×t" },
    { x: CT,            y: CT,         w: CP, h: CL, color: "#eab308", label: "p×l" },
    { x: CT,            y: CT+CL,      w: CP, h: CT, color: "#3b82f6", label: "p×t" },
    { x: CT+CP,         y: CT,         w: CT, h: CL, color: "#f97316", label: "l×t" },
    { x: CT+CP+CT,      y: CT,         w: CP, h: CL, color: "#ef4444", label: "p×l" },
  ],
  [
    { x: CL,    y: 0,          w: CP, h: CT, color: "#8b5cf6", label: "p×t" },
    { x: CL,    y: CT,         w: CP, h: CL, color: "#eab308", label: "p×l" },
    { x: CL-CT, y: CT,         w: CT, h: CL, color: "#22c55e", label: "l×t"  },
    { x: CL+CP, y: CT,         w: CT, h: CL, color: "#f97316", label: "l×t"  },
    { x: CL,    y: CT+CL,      w: CP, h: CT, color: "#3b82f6", label: "p×t" },
    { x: CL,    y: CT+CL+CT,   w: CP, h: CL, color: "#ef4444", label: "p×l" },
  ],
  [
    { x: 0,             y: CT+CL,      w: CT, h: CL, color: "#22c55e", label: "l×t" },
    { x: CT,            y: 0,          w: CP, h: CT, color: "#8b5cf6", label: "p×t" },
    { x: CT,            y: CT,         w: CP, h: CL, color: "#eab308", label: "p×l" },
    { x: CT,            y: CT+CL,      w: CP, h: CL, color: "#ef4444", label: "p×l" },
    { x: CT+CP,         y: CT+CL,      w: CT, h: CL, color: "#f97316", label: "l×t" },
    { x: CT+CP,         y: CT+CL+CL,   w: CT, h: CP, color: "#3b82f6", label: "p×t" },
  ],
  [
  ...
  [
    ...
    { x: CT,            y: 0,          w: CP, h: CL, color: "#eab308", label: "p×l" },
    { x: CT,            y: CL,         w: CP, h: CL, color: "#ef4444", label: "p×l" },
    { x: CT+CP,         y: CL,         w: CT, h: CL, color: "#f97316", label: "l×t" },
    { x: CT+CP,         y: CL+CL,      w: CT, h: CP, color: "#8b5cf6", label: "p×t" },
    { x: CT+CP+CT,      y: CL+CL,      w: CT, h: CP, color: "#3b82f6", label: "p×t" },
  ],
  [
    { x: 0,     y: 0,          w: CL, h: CT, color: "#22c55e", label: "l×t" },
    { x: CL,    y: 0,          w: CP, h: CT, color: "#8b5cf6", label: "p×t" },
